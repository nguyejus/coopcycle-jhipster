...
import com.nguyejus.coopcycle.repository.OrderContentRepository;
import com.nguyejus.coopcycle.service.OrderContentService;
import com.nguyejus.coopcycle.service.dto.OrderContentDTO;
import com.nguyejus.coopcycle.service.mapper.OrderContentMapper;
...
class OrderContentResourceIT {
    ...
    void partialUpdateOrderContentWithPatch() throws Exception {
        ...
        partialUpdatedOrderContent.iDproduct(UPDATED_I_DPRODUCT).iDorder(UPDATED_I_DORDER).productAvailable(UPDATED_PRODUCT_AVAILABLE);
